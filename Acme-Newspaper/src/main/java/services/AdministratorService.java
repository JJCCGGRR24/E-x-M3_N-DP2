...
public class AdministratorService {
	...
	public Double query2C1() {
		return this.administratorRepository.query2C1();
	}

	public Double query2C2() {
		Assert.isTrue(LoginService.isPrincipalAdmin());

		return this.administratorRepository.query2C2();
	}

	public Double query2B1() {
		Assert.isTrue(LoginService.isPrincipalAdmin());

		return this.administratorRepository.query2B1();
	}

	public Double query2B2() {
		return this.administratorRepository.query2B2();
	}
