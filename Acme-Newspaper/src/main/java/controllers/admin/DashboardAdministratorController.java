...
public class DashboardAdministratorController extends AbstractController {
	...
	public ModelAndView dashboard() {
		...
		final Double query2C1 = this.administratorService.query2C1();
		modelAndView.addObject("query2C1", query2C1);

		final Double query2C2 = this.administratorService.query2C2();
		modelAndView.addObject("query2C2", query2C2);

		final Double query2B1 = this.administratorService.query2B1();
		modelAndView.addObject("query2B1", query2B1);

		final Double query2B2 = this.administratorService.query2B2();
		modelAndView.addObject("query2B2", query2B2);
