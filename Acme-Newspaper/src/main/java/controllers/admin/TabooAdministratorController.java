...
public class TabooAdministratorController extends AbstractController {
	...
	public ModelAndView listArticleTabooWord() {
	...
	@RequestMapping(value = "/listAdvertisementTabooWord", method = RequestMethod.GET)
	public ModelAndView listAdvertisementTabooWord() {
		final ModelAndView result = new ModelAndView("advertisement/list");
		final List<Advertisement> tw = (List<Advertisement>) this.advertisementService.getAdvertisementsWithTabbooWords();
		result.addObject("requestURI", "taboo/admin/listAdvertisementTabooWord.do");
		result.addObject("advertisements", tw);
		return result;
	}
