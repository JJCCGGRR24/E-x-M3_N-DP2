...
<div align="center">
	<ul id="jMenu">
		...
		<li><a class="fNiv" href="volume/all/list.do"><spring:message
					code="master.page.volumes" /></a>
			<security:authorize access="hasRole('USER')"><ul>
				<li class="arrow"></li>
				<li><a href="volume/user/myList.do"><spring:message
						code="master.page.myVolumes" /></a></li>
			...
			<li><a class="fNiv"><spring:message code="master.register" /></a>
				<ul>
					...
					<li><a href="register/user.do"><spring:message
								code="master.register.user" /></a></li>
					<li><a href="register/customer.do"><spring:message
								code="master.register.customer" /></a></li>
					<li><a href="register/agent.do"><spring:message
								code="master.register.agent" /></a></li>
				</ul></li>
		...
		<security:authorize access="hasRole('ADMIN')">
			...
			<li><a class="fNiv"><spring:message
				...
				<ul>
					...
					<li><a href="taboo/admin/listAdvertisementTabooWord.do"><spring:message
 								code="master.page.listAdsTabooWord" /></a></li>
				</ul></li>
				
				<li><a class="fNiv" href="advertisement/admin/list.do"><spring:message
						code="master.page.listAdvertisements" /></a></li>
		</security:authorize>
		...
		<security:authorize access="hasRole('AGENT')">
			<li><a><spring:message
				...
				<ul>
					<li class="arrow"></li>
					<li><a href="advertisement/agent/myList.do"><spring:message
								code="master.page.advertisements" /></a>
		...
		<security:authorize access="isAuthenticated()">
			<li><a class="fNiv" href="folder/actor/list.do"> <spring:message
						code="mater.page.messenger" />
			</a>
				<security:authorize access="hasRole('ADMIN')">
					<ul>
						<li class="arrow"></li>
						<li><a href="message/admin/broadcast.do"><spring:message
