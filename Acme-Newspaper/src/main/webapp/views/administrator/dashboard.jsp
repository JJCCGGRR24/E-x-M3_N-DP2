...
<display:table name="queryC4" id="row" class="displaytag" pagesize="10" requestURI="admin/dashboard.do">
...
<display:table name="queryC5" id="row" class="displaytag" pagesize="10" requestURI="admin/dashboard.do">
	<display:column titleKey="general.title" >
		<jstl:out value="${row}" />
	</display:column>
</display:table>
...
<h2>
	<spring:message code="administrator.query2C1" />
</h2>
<b> <spring:message code="administrator.ratio" /> :
</b>
<fmt:formatNumber value="${query2C1}" maxFractionDigits="2" />
<jstl:if test="${query2C1 eq null}">
	<spring:message code="administrator.nodata" />
</jstl:if>
<br />

<h2>
	<spring:message code="administrator.query2C2" />
</h2>
<b> <spring:message code="administrator.ratio" /> :
</b>
<fmt:formatNumber value="${query2C2}" maxFractionDigits="2" />
<jstl:if test="${query2C2 eq null}">
	<spring:message code="administrator.nodata" />
</jstl:if>
<br />

<h2>
	<spring:message code="administrator.query2B1" />
</h2>
<b> <spring:message code="administrator.avg" /> :
</b>
<fmt:formatNumber value="${query2B1}" maxFractionDigits="2" />
<jstl:if test="${query2B1 eq null}">
	<spring:message code="administrator.nodata" />
</jstl:if>
<br />

<h2>
	<spring:message code="administrator.query2B2" />
</h2>
<b> <spring:message code="administrator.ratio" /> :
</b>
<fmt:formatNumber value="${query2B2}" maxFractionDigits="2" />
<jstl:if test="${query2B2 eq null}">
	<spring:message code="administrator.nodata" />
</jstl:if>
<br />
