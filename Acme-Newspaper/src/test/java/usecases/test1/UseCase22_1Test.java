		...
		final Object testingData[][] = {
			{
				...
				"customer3", "Jose Carlos", "MASTERCARD", "4000990618525905", 2020, 2, 451, "newspaper1_2", null
			}, {
				//comprobaremos que un customer no puede suscribirse a un newspapaer si este es publico
				"customer3", "Jose Carlos", "VISA", "4000990618525905", 2020, 02, 450, "newspaper1", IllegalArgumentException.class
			}
		};
